...
class GBBAdminController extends ControllerBase {
  ...
  public function gavias_blockbuilder_edit($bid) {
    ...
    $abs_url_config = \Drupal::url('gavias_blockbuilder.admin.save', array(), array('absolute' => TRUE));
    $page['#attached']['drupalSettings']['gavias_blockbuilder']['saveConfigURL'] = $abs_url_config;

    $abs_url_config = \Drupal::url('gavias_blockbuilder.admin.get_images_upload', array(), array('absolute' => TRUE));
