...
class gavias_bb_fields{
	...
	public function render_field_upload($field = array(), $value = ''){
		...
		if( $value ){
			$path_image_demo = base_path() . $value;
		}else{
		...
		<div class="gva-upload-image" id="gva-upload-<?php print $_id; ?>">
			<form class="upload" id="upload-<?php print $_id; ?>" method="post" action="<?php print ($base_url . '/admin/structure/gavias_blockbuilder/upload') ?>" enctype="multipart/form-data">
				<div class="drop">
